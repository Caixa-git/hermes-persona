...
Hermes Persona bridges [Hermes Agent](https://github.com/nousresearch/hermes-agent)'s kanban task workers with [agency-agents](https://github.com/nicepkg/agency-agents)'s 210+ expert role definitions.
...
### [agency-agents](https://github.com/nicepkg/agency-agents) by nicepkg 🏆
210+ meticulously crafted specialist role definitions across 17 domains — engineering, design, testing, PM, game dev, academic, finance, marketing, sales, support, product, and more.
This project would not exist without their outstanding role catalog. The heart of the persona system.

### [Hermes Agent](https://github.com/nousresearch/hermes-agent) by Nous Research 🏆
Multi-agent orchestration framework with kanban-based task distribution and skill injection.
...
- [ ] **Intelligent role selection** — task analysis using agent/occupational psychology research papers to pick the optimal role
